...
<body>
    ...
    <aside style="background-color: var(--blue); width: 300px; z-index: 100;" >
        ...
        <section class="d-flex flex-column sidebar">
          ...
          <a href="subjects.php" class="d-flex flex-row align-items-center gap-2 p-3 text-decoration-none">
            <i class="fa-solid fa-gauge" style="color: white;"></i>
            <p  class="text-white m-0">Subjects</p>
          </a>
  
          <a href="students.php" class="d-flex flex-row align-items-center gap-2 p-3 text-decoration-none">
            <i class="fa-solid fa-user-group fa-xs" style="color: #ffffff;"></i>
            <p class="text-white m-0">Students</p>
          </a>
  
          <a href="grades.php" class="d-flex flex-row align-items-center gap-2 p-3 text-decoration-none">
