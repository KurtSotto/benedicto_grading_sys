...
<body>
    ...
    <div style="z-index: 200; border-bottom: 1px solid rgb(24, 49, 83);" class="d-flex justify-content-between align-items-center">
        <h3 class="pb-3 text-dark m-0">Classes</h3>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add new class</button>
    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="floatingInput" placeholder="level">
                    <label for="floatingInput">Level</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="name" class="form-control" id="floatingInput" placeholder="section">
